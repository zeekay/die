...
Die = (function() {
  ...
  function Die(options) {
    ...
    this.base = options.basePath || process.cwd();
    this.readConfig();
  }
  ...
  Die.prototype.createServer = function(cb) {
    var app;
    app = server(this);
    if (cb && cb.call) {
      cb.call(app);
  ...
  Die.prototype.cssPackage = function() {
    var cssPath;
    cssPath = join(this.base, this.options.css);
    return pkg.createCss(cssPath);
  };
